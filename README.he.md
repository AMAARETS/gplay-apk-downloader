...
- ✅ תמיכה בטוקן ידני (אם GitHub חסום)
- ✅ אופציה לשימוש ב-Tor proxy

#### הגדרה ראשונית

אם GitHub Actions חסום על ידי ה-dispenser (שגיאת 403), ראה [מדריך הגדרה](GITHUB_ACTIONS_SETUP.he.md) לפתרונות.

**פתרון מהיר:** הרץ `./gplay auth` במחשב המקומי והוסף את הטוקן כ-Secret בשם `GPLAY_AUTH_TOKEN`.
